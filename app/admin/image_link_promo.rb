if defined?(ActiveAdmin) and Promotion.config.engine_active_admin and !Promotion.config.local_admin_pages.include?(:image_link)
  ActiveAdmin.register Promotion.localisable_class(:ImageLinkPromo) do
    ...
    menu :parent => "Promotions", :label => "Image Link"
